...
final readonly class CacheStage
{
    public function __construct(
        public ?string $id = null,
        public ?string $pipelineId = null,
        public ?string $fallbackTtl = null,
    ...
    public static function from(array $data): self
    {
        return new self(
            ...
            isset($data['fallback_ttl']) && \is_scalar($data['fallback_ttl']) ? (string) $data['fallback_ttl'] : null,
            isset($data['include_cookies']) ? (bool) $data['include_cookies'] : null,
